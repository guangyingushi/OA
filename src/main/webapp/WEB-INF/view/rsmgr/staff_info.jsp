...
<!-- <div id="contact_form">
        <table width="281" border="0">
                  <tr>
                    <td width="81" height="40">工号：</td>
                    <td width="68">1001</td>
                     <td width="118" height="100" rowspan="4"> <img src="../images/default.png" style="width:100px;height:100px;"/></td>
                  </tr>
                  ...
                  <tr>
                   ...
                   <tr>
                    <td  height="40">入职时间：</td>
                    <td colspan="2">2013年9月22日</td>
                  </tr>
                </table>
                <br/>
     ...
     <br/><br/><br/>
       <h5><strong>账号安全</strong></h5>
          <form action="#" method="get">
            <label for="name">原密码?</label>
             <input type="text" name="name" id="name" class="input_field" /><em style="color:#F00">&nbsp;*</em>
            <div class="cleaner h10"></div>
        
              <label for="pwds">新密码?</label>
              <input type="text" name="pwds" id="pwds" class="input_field" /><em style="color:#F00">&nbsp;*</em>
              <div class="cleaner h10"></div>
               <label for="pwds">再次输入新密码?</label>
              <input type="text" name="pwds" id="pwds" class="input_field" /><em style="color:#F00">&nbsp;*</em>
              <div class="cleaner h10"></div>
...
<div class="row" style="margin-left: 5px;" >
        <div class="col-md-4" style="margin-right: 85px;width:1500px">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="box-footer">
              <ul class="nav nav-stacked">
                ...
                <li><a href="#">创建时间：</a></li>
                <li><a href="#">调动原因：</a></li>
                <li><a href="#">调动前部门职位：</a></li>
                <li><a href="#">调动后部门职位：</a></li>
                <li><a href="#">调动状态：</a></li>
                <li><a href="#">审核人：</a></li>
                <li><a href="#">审核意见：</a></li>               
                <a href="/Users/Administrator/Desktop/AdminLTE-master/pages/tables/data3.html"><button type="button" class="btn btn-default btn-block" style="background:#FF7F50;color: #FFFFFF" >返回列表</button></a>               
              </ul>
...
<div class="register-box" >
  <div class="register-logo">
    <a href="../../index2.html"><b>修改密码</b>ADMIN</a>
  </div>
