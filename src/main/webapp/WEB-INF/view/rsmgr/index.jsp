      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i> 员工管理</a></li>
			<li class="active"><a href="index3.html"><i class="fa fa-circle-o"></i> 调动管理</a></li>
			<li class="active"><a href="index4.html"><i class="fa fa-circle-o"></i> 通讯录管理</a></li>            
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
