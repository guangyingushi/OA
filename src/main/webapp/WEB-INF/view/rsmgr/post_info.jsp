          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="box-footer">
              <ul class="nav nav-stacked">
                ...
                <li><a href="#">审核人：</a></li>
                <li><a href="#">审核意见：</a></li>               
                <a href="/Users/Administrator/Desktop/AdminLTE-master/pages/tables/data4.html"><button type="button" class="btn btn-default btn-block" style="background:#FF7F50;color: #FFFFFF" >返回列表</button></a>               
              </ul>
