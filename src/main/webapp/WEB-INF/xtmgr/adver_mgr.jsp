...
<title>[OA] 办公自动化 - 系统管理 - 公告管理页</title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div class="accordion">
         ...
         <div class="cleaner"></div>
         <br/> <br/> <br/>
        <h5><strong>公告发布</strong></h5>
             <div id="contact_form">
               <form method="post" name="contact" action="#">
                    
                    <label for="author">公告主题 ? </label> 
                    <input type="text" id="author" name="author" class="required input_field" /><em style="color:#F00">&nbsp;*</em>
                    <div class="cleaner h10"></div>
                         
                    <label for="text">公告主体内容 ?</label>
                     <textarea id="text" name="text" rows="0" cols="0" class="required"></textarea><em style="color:#F00">&nbsp;*</em>
                    <div class="cleaner h10"></div>
