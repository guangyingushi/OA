...
<title>[OA] 办公自动化 - 系统管理 - 守则管理页</title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div class="accordion">
         ...
         <div class="cleaner"></div>
         <br/> <br/> <br/>
        <h5><strong>员工守则发布</strong></h5>
             <div id="contact_form">
               <form method="post" name="contact" action="#">
                    
                    <label for="author">员工守则类型 ? </label> 
            ...
            <h5><strong>守则列表</strong></h5>
                <table width="700px" cellspacing="0" cellpadding="5">
                   	 <tr bgcolor="#CCCCCC">
                     		<th width="70" align="left"><input id="chk_SelectALL" type="checkbox" />全选</th> 
                    	...
                    	<tr>
                            ...
                            <td>2013-09-28</td> 
                            <td>旭阳科技</td> 
                            <td><a href="#" class="more">修改</a>&nbsp;<a href="#" class="more">删除</a></td>
						</tr>
                        <tr>
                        	<td>
