...
<title>[OA] 办公自动化 - 系统管理 - 日志明细页</title>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
           ...
           <div class="accordion">
                ...
                <h3>模块说明</h3>
                <div>
                	<p>系统管理模块-日志明细-该页面查看日志详细信息</p>
                </div>
                
                <h3>操作介绍</h3>
                <div>
                	<p>[返回列表] -该方案用来跳转到日志管理页面</p>
                </div>                           
            ...
            <br/>
			<a href="log_login.html" class="more float_l">返回列表</a>
        ...
        <div id="contact_form" style="width:400px;">
   	    	<table width="402" >
              <tr>
                <td width="152" height="40">操作者：</td>
                <td width="234">张三</td>
              </tr>
              <tr>
                <td height="40">操作名称：</td>
                <td>添加</td>
              </tr>
              <tr>
                <td height="40">操作描述：</td>
                <td>添加一个新的员工</td>
              </tr>
              <tr>
            ...
            <br/>
			<a href="log_operate.html" class="more float_l">返回列表</a>
